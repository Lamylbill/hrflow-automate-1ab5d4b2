    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="union_membership">Union Membership</Label>
            <Input
              id="union_membership"
        ...
        <div className="space-y-4">
          <div>
            <Label htmlFor="cpf_contribution">CPF Eligibility</Label>
            <Controller
      ...
      {showAdvancedFields && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="statutory_date_start">Statutory Date Start</Label>
              <Controller
                control={control}
            ...
            <div>
              <Label htmlFor="statutory_date_end">Statutory Date End</Label>
              <Controller
                control={control}
