// src/components/employees/tabs/ComplianceTab.tsx
...
export const ComplianceTab: React.FC<ComplianceTabProps> = ({ 
  ...
  const complianceFields = getEmployeeFieldsByCategory('compliance');
  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 md:px-8">
      ...
      {renderFieldGroups(methods, complianceFields, isViewOnly, showAdvancedFields)}
    </div>
  );
};
